<script type="text/javascript">
  ...
  ( function ( $ ) {
    ...
    $.carouselOfReviews_config = $.carouselOfReviews_config || {
      ...
      confClass_prop_ky_autoPlayInterval : 8050 ,
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {

            console .log ('%c' + objsMergedIntoOneNewOb .id + ' instantiating object from reviews_carouselClass class', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' get carousel elements and assign value to class property keys ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' gathering carousel data ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' update carousel class transitions ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' get carousel dimensions ', 'color:#0053A0') ;
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' update carousel dimensions height and width ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' setting transition type ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' creating slide clone ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' creating slide index go to indication dot control ', 'color:#0053A0');
	...
	*/
	...
	/*
                ...
                if ( objsMergedIntoOneNewOb .debug ) {
                  ...
                  console.log('%c--- slide index navigation indicator dot click ---', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' adding previous and next arrow button control ', 'color:#0053A0');
	...
	*/
	...
	/*
                ...
                if ( objsMergedIntoOneNewOb .debug ) {
                  ...
                  console .log( '%c--- right arrow button clicked action : slide left to next slide ---', 'color:#0053A0' ) ;
	...
	*/
	...
	/*
                ...
                if ( objsMergedIntoOneNewOb .debug ) {
                  ...
                  console .log( '%c--- left arrow button clicked action : slide right to previous slide ---', 'color:#0053A0' ) ;
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb.id + ' add controls pause and play ', 'color:#0053A0' ) ;
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb .id + ' hiding control previous and next arrows buttons ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb .id + ' autoplay carousel slides', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' get the specified slide position ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ( '%c' + objsMergedIntoOneNewOb .id + ' get the first slide's position ', 'color:#0053A0' );
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' get the last slide's position ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' get the first cloned slide's position ', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ( '%c' + objsMergedIntoOneNewOb .id + ' get the last cloned slide's position ', 'color:#0053A0' );
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb .id + ' slide right to previous slide', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb.id + ' slide left to next slide', 'color:#0053A0');
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console.log( '%c' + objsMergedIntoOneNewOb .id + ' goTo ' + slideIndexNumber,, 'color:#0053A0');
	...
	*/
	...
	/*
            ...
            if ( objsMergedIntoOneNewOb .debug ) {
              ...
              console .log ( '%c' + objsMergedIntoOneNewOb .id + ' ' + objsMergedIntoOneNewOb .confClass_prop_ky_slideDirection, 'color:#0053A0' ) ;
	...
	*/
	...
	/*
              ...
              if ( objsMergedIntoOneNewOb .debug ) {
                ...
                console .log ( '%c--- swipe rich - ' + phase + ' - ' + direction + ' - ' + distance + ' - ' + orientation + ' ---', 'color:#0053A0' ) ;
	...
	*/
	...
	/*
          ...
          if ( objsMergedIntoOneNewOb .debug ) {
            ...
            console .log ('%c' + objsMergedIntoOneNewOb .id + ' prepare this object for garbage collection', 'color:#0053A0' ) ;
